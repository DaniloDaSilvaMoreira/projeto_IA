...
class AlgoritmoGenetico:
    def __init__(self, TAM_POP, TAM_GENE, numero_geracoes=100):
        print("Algoritmo Genético. Executado por Danilo da Silva.")
        ...
        self.melhor_individuo = None  # Armazena o melhor indivíduo
        self.melhor_aptidao = -float('inf')  # Armazena a melhor aptidão
        self.melhor_geracao = 0  # Armazena a geração do melhor indivíduo
...
ag = AlgoritmoGenetico(TAM_POP=10, TAM_GENE=10, numero_geracoes=50)
